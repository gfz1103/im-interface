 ...
 * 类描述：住院_病区组套医嘱
 * @author GONGFANGZHOU 
 * @ApiModel(value="住院_病区组套医嘱")
 */
public class CisHzyzZtModel extends  PageQuery{
	/**
	...
	*/
	...
	//@ApiModelProperty(value="组套医嘱类型 0检查医嘱，1检验医嘱")
    /** 组套医嘱类型 0检查医嘱，1检验医嘱 */
    ...
    /** 设置:审方结果  */
    public void setSfjg(BigDecimal value) {
        this.sfjg = value;
    }
    /** 获取:审方结果 */
    ...
    /** 设置:组套医嘱类型 0检查医嘱，1检验医嘱  */
    public void setYzlx(Integer value) {
        this.yzlx = value;
    }
    /** 获取:组套医嘱类型 0检查医嘱，1检验医嘱 */
