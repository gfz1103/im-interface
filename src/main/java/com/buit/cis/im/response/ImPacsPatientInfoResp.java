 ...
 */
@ApiModel(value="PACS病人信息提取返回_PatientInfoResp")
public class ImPacsPatientInfoResp implements Serializable {
    private static final long serialVersionUID = 2188015746508749825L;
